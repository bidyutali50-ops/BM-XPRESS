...
import { Bike, CheckCircle2, MapPin, Package, Truck } from "lucide-react";
      ...
      <div className="container">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            A live look at the same dashboard your team and your customers see —
            rider position, route and ETA, updated continuously.
          </p>
        </div>
        ...
        >
          ...
          <div className="relative h-[380px] border-b border-border bg-ink-900 p-6 lg:border-b-0 lg:border-r">
            ...
            <svg viewBox="0 0 600 300" className="relative mt-4 h-[280px] w-full">
              ...
              />
              <circle cx="40" cy="200" r="6" fill="#2A2140" />
              <circle cx="560" cy="160" r="6" fill="#7C5CFC" />

              <g ref={markerRef}>
                <circle r="12" fill="#7C5CFC" opacity="0.25" />
                <circle r="7" fill="#7C5CFC" />
              </g>
            </svg>
